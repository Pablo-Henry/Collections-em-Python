...
# Para utilizar o total_ordering é necessário ter implementado algumas funções (as que você quiser). Ex: __lt__, __eq__, __ge__

# Utilizado para oferecer todas as Funções de comparação, sem ele não conseguimos comparar se um valor é menor ou igual
# a outro
@total_ordering
class ContaSalario:
